<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('user.address') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="address" id="address" required wire:model.defer="user.address">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('user.user_type') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="user_type" id="user_type" required wire:model.defer="user.user_type">
        <div class="validation-message">
