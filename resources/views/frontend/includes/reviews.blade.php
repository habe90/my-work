					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-9">
							<div class="sec-heading">
								<h2>Was die Leute <span class="theme-cl-2">sagen</span></h2>
								<p>Entdecken Sie die Erfahrungen unserer Kunden und wie unsere Dienstleistungen dazu beigetragen haben, ihre Projekte erfolgreich umzusetzen.</p>
							</div>
						</div>
					</div>
