...
@section('content')
    <style>
        ...
        .user-image img {
            width: 50px;
            /* Ili bilo koja druga veličina */
            height: 50px;
            border-radius: 50%;
            /* Da bi slika bila u obliku kruga */
            object-fit: cover;
            margin-right: 10px;
        }
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">
                                            {{ Breadcrumbs::render('dashboard') }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="{{ $settings1['column_class'] }}">
                            <div class="dashboard-stat">
                                ...
                                <div class="dashboard-stat-content">
                                    <h4><span class="cto"> <a
                                                href="{{ route('bids.index') }}">{{ number_format($settings1['total_number']) }}</a></span>
                                    </h4>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="dashboard-stat">
                                ...
                                <div class="dashboard-stat-content">
                                    <h4><span class="cto"><a
                                                href="{{ route('review.show') }}">{{ number_format($settings2['total_number']) }}</a></span>
                                    </h4>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="dashboard-stat">
                                ...
                                <div class="dashboard-stat-content">
                                    <h4><span class="cto">{{ number_format($settings3['total_number']) }}</span></h4>
                                        ...
                                        @foreach ($bids as $bid)
                                            <li>
                                                @if ($bid->status === 'accepted')
                                                    <i class="dash-icon-box ti-layers text-purple bg-light-purple"></i> Your
                                                    bid for <strong><a
                                                            href="{{ route('jobs.show', ['job' => myCryptie($bid->job->id, 'encode')]) }}">{{ $bid->job->title }}</a></strong>
                                                    is <span class="badge badge-success">accepted!</span>
                                                @elseif($bid->status === 'rejected')
                                                    <i class="dash-icon-box ti-heart text-danger bg-light-danger"></i> Your
                                                    bid for <strong><a
                                                            href="{{ route('jobs.show', ['job' => myCryptie($bid->job->id, 'encode')]) }}">{{ $bid->job->title }}</a></strong>
                                                    is <span class="badge badge-danger">declined!</span>
                                                @endif
